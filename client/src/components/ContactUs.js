...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center justify-center mt-12 mb-6 px-4">
        <div className="bg-gray-50 rounded-lg p-6 shadow-sm border border-gray-200 max-w-md w-full">
          <div className="text-center">
            <p className="text-gray-600 text-sm mb-3">
              Developed and Maintained by Sanyam Garg (sanyam22448@iiitd.ac.in)
            </p>
            <a
              href={contactContent.footer?.github || 'https://github.com/SanyamGarg12'}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200 shadow-sm hover:shadow-md"
            >
